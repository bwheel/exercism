...
public class SecurityPassMaker
{
    ...
    {
        Manager or Chairman => "Too Important for a Security Pass",
        Security and not (SecurityJunior or PoliceLiaison or SecurityIntern) => "Security Team Member Priority Personnel",
        _ => support.Title,
    };
}
